        ...
        <div className="container">
          <a className="navbar-brand d-inline-flex" href="#">
            <img
              ...
              alt="logo"
            />
            <span className="text-1000 fs-0 fw-bold ms-2">J</span>
          </a>
          <button
            ...
            <div className="col-sm-9 col-md-4 mb-3 mb-md-0 h-100">
              <div className="card card-span text-white h-100">
                ...
                <div className="card-body px-xl-5 px-md-3 pt-0 pb-7">
                  ...
                  <p className="text-900 mt-3">
                    While the fashion industry has had a calm year, this season
                    has seen some beautiful pieces. Over the previous several
                    weeks, commanding coats, and elegant face masks have ruled
                    Fashion Weeks...
                  </p>
                  <a
                    className="btn btn-lg text-900 fs-1 px-0 hvr-icon-forward"
            ...
            <div className="col-sm-9 col-md-4 mb-3 mb-md-0 h-100">
              <div className="card card-span text-white h-100">
                ...
                <div className="card-body px-xl-5 px-md-3 pt-0 pb-7">
                  ...
                  <p className="text-900 mt-3">
                    Explore the first real-time photographic fashion magazine
                    NOWFASHION to broadcast exclusive live fashion shows. Some
                    of the most beautiful spring collection i want to share. See
                    the....
                  </p>
                  <a
                    className="btn btn-lg text-900 fs-1 px-0 hvr-icon-forward"
          ...
          <div className="row">
            ...
            <div className="col-sm-6 col-lg-auto ms-auto">
              ...
              <p className="text-800">
                ...
                <span className="text-800">+(201)660-4655</span>
              </p>
              <p className="text-800">
                <svg
                ...
                <span className="text-800">johnsantana87@gmail.com</span>
              </p>
            </div>
          </div>
          ...
          <div className="row flex-center my-3">
            <div className="col-md-6 order-1 order-md-0">
              <p className="my-2 text-1000 text-center text-md-start">
                ...
                <a
                  className="text-800"
                  href="https://github.com/theJondar"
                  target="noreferrer"
                >
                  Jondar{" "}
                </a>
